...
uint256 hashGenesisBlock("0x4482a9abf0770a9d55246141c0542b98f7bda55f8753348db7965c39c4f65f0d");
...
const string strMessageMagic = "1312 Signed Message:\n";
...
{
    int64 nSubsidy = 15 * COIN; //Amt of coins per block


//    if(nHeight < 17280) // no block reward within the first 3 days
//        nSubsidy = 0;
    if(nHeight > 17280) // no block reward after 3 days
        nSubsidy = 0;

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 0.35 * 24 * 60 * 60; // 1312: 0.35 days
static const int64 nTargetSpacing = 120; // 1312: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal 1312 miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "1312", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	CBlock(hash=14dc23f54de47df79717, PoW=00000aeb1f05fbf0b2fa, ver=1, 			hashPrevBlock=00000000000000000000, hashMerkleRoot=ef7e256a2c, 			nTime=1399574511, nBits=1e0ffff0, nNonce=2086299649, vtx=1)
  	...
  	vMerkleTree: ef7e256a2c */
        ...
        // Genesis block
        const char* pszTimestamp = "all cops are bastard";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1480872376;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2087095422;
        ...
        assert(block.hashMerkleRoot == uint256("0xb969402491ca63ccb53ea855db9bb6092f0ecbdd99a53160bfce8b26424804b7"));

        // If genesis block hash does not match, then generate new genesis hash.
        if (true && block.GetHash() != 0x4482a9abf0770a9d55246141c0542b98f7bda55f8753348db7965c39c4f65f0d)
        {
